    ...
    >
      ...
      >
        ...
        <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
          <div style={{ height: 54, overflow: 'hidden', flexShrink: 0 }}>
            <img src="/images/logo.png" alt="VeriSeal" style={{ height: 72, width: 'auto', display: 'block' }} />
          </div>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <Link href="/pricing" className="desktop-nav" style={{ textDecoration: 'none' }}>
            <button
              style={{
      ...
      {menuOpen && (
        ...
        >
          ...
          <Link href="/pricing" onClick={() => setMenuOpen(false)} style={{ textDecoration: 'none' }}>
            <button
              style={{
                marginTop: 20,
                width: '100%',
