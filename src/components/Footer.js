      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, margin: 0 }}>
            A modular NFC and biometric-secured pod engineered as a hardware-software platform, not a single-purpose safe. Guarded by Denny the seal.
          </p>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <Link to="/shop" style={{ textDecoration: 'none', color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>
              Shop Denny
            </Link>
            <Link to="/privacy" style={{ textDecoration: 'none', color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>
              Privacy Policy
            </Link>
            <Link to="/terms" style={{ textDecoration: 'none', color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>
              Terms of Service
            </Link>
          </div>
        </div>
