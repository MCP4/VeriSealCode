...
const CAPABILITIES = [
  {
    type: 'modular',
    title: 'A smart pod',
    body: 'A tough enclosure with integrated sensors and secure locking. One rugged chassis that reconfigures for almost any environment.',
  },
  {
    type: 'nfc',
    title: 'A digital access system',
    body: 'One-tap NFC and biometric unlocking for you, plus revocable one-time tokens for couriers, friends, and guests. Hand out access, not your keys.',
  },
  {
    type: 'telemetry',
    title: 'A live telemetry layer',
    body: 'Continuous geo-location, motion, force, and lid-state monitoring, so you always know when and how your pod was accessed.',
  },
];
        ...
        >
          <div style={{ maxWidth: 680 }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <a href={process.env.REACT_APP_TIKTOK_URL || '#'} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '9px 18px', borderRadius: 'var(--radius-button)', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 500, transition: 'background 150ms ease' }} className="hero-social-link">
              ...
              <a href={process.env.REACT_APP_INSTAGRAM_URL || '#'} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '9px 18px', borderRadius: 'var(--radius-button)', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)', color: '#fff', textDecoration: 'none', fontSize: 14, fontWeight: 500, transition: 'background 150ms ease' }} className="hero-social-link">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
          ...
          <div className="hero-illustration" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{
              ...
              <CoverImage
                ...
                alt="Denny the seal tapping the VeriSeal NFC pod at a door"
                priority
              />
            </div>
          </div>
      ...
      <section style={{ background: 'var(--color-bg-alt)', padding: '96px 32px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ fontFamily: 'var(--font-mono, JetBrains Mono, monospace)', fontSize: 12, color: 'var(--color-alert)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 16 }}>
              The Truth
            </div>
            <h2 style={{ margin: '0 auto 16px', maxWidth: 680, fontWeight: 700, fontSize: 'clamp(28px, 3.5vw, 40px)', color: 'var(--color-dark)', letterSpacing: '-0.01em' }}>
              Your stuff is vulnerable right now.
            </h2>
            <p style={{ margin: '0 auto', maxWidth: 600, fontSize: 16, color: 'var(--color-text)', lineHeight: 1.7 }}>
              Modern life runs on deliveries, shared spaces, and constant motion — and security hasn’t kept up. Packages vanish off porches. Roommates “borrow” without asking. Lockers pop open with a bump. The products meant to fix this each solve one tiny slice:
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }} className="problem-grid">
            {[
              { title: 'Static safes', body: 'Bolt to one spot and never adapt. Security that can’t move with you.' },
              { title: '“Smart” locks', body: 'Guard a door but have no idea what happens inside — or after it opens.' },
              { title: 'Single-use boxes', body: 'Can’t follow you from your apartment to your car to your next trip.' },
            ].map((item) => (
              <div
                key={item.title}
                style={{
                  ...
                  padding: '28px',
                  borderTop: '3px solid var(--color-alert)',
                }}
              >
                <h3 style={{ margin: '0 0 8px', fontWeight: 700, fontSize: 16, color: 'var(--color-dark)' }}>{item.title}</h3>
                <p style={{ margin: 0, fontSize: 14, color: 'var(--color-text)', lineHeight: 1.6 }}>{item.body}</p>
              </div>
            ))}
          </div>

          <p style={{ margin: '40px auto 0', maxWidth: 600, textAlign: 'center', fontSize: 16, color: 'var(--color-dark)', fontWeight: 600, lineHeight: 1.6 }}>
            You end up buying three or four gadgets that don’t talk to each other and still leave gaps. This is where we come in.
          </p>
        </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <CoverImage
              ...
              alt="The VeriSeal pod family — all sizes and form factors"
            />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }} className="product-grid">
            <div style={{
              ...
              <CoverImage src="/images/large-design.png" alt="VeriSeal large pod" />
              <div style={{
            ...
            <div style={{
              ...
              <CoverImage src="/images/medium-design.png" alt="VeriSeal medium pod" />
              <div style={{
                position: 'absolute', bottom: 0, left: 0, right: 0,
                padding: '20px 24px',
                background: 'linear-gradient(transparent, rgba(13,31,26,0.72))',
      ...
      <section style={{ background: 'var(--color-bg-alt)', padding: '96px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 style={{ margin: '0 auto', maxWidth: 640, fontWeight: 700, fontSize: 'clamp(28px, 3.5vw, 40px)', color: 'var(--color-dark)', letterSpacing: '-0.01em' }}>
              Three things make it powerful — all in one compact device.
            </h2>
          </div>
      ...
      <section style={{ background: '#fff', padding: '96px 32px' }}>
        ...
        >
          <div style={{ borderRadius: 24, overflow: 'hidden', position: 'relative', aspectRatio: '4/3' }}>
            <CoverImage src="/images/seal-1.png" alt="Denny the seal holding a VeriSeal pod" />
          </div>
          <div>
            <div style={{ fontFamily: 'var(--font-mono, JetBrains Mono, monospace)', fontSize: 12, color: 'var(--color-primary)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 16 }}>
              Secure by Nature
            ...
            <p style={{ margin: '0 0 24px', fontSize: 16, color: 'var(--color-text)', lineHeight: 1.7 }}>
              Denny the seal isn&apos;t decoration. Seals are naturally airtight, intelligent, and agile. So is the product. Denny carries the brand voice across social, packaging, and every campaign — because trust is easier when it has a face.
            </p>
            <p style={{ margin: '0 0 32px', fontSize: 14, color: 'var(--color-text)', lineHeight: 1.7 }}>
              Follow Denny on TikTok and Instagram, or take him home from the shop.
            </p>
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <Link to="/shop" className="mascot-social-btn mascot-social-dark">
                Shop Denny
              </Link>
              <a href={process.env.REACT_APP_TIKTOK_URL || '#'} target="_blank" rel="noopener noreferrer" className="mascot-social-btn mascot-social-outline">
